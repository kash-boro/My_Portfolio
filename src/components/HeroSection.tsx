    ...
    <section className="relative min-h-screen flex flex-col items-center justify-center px-4 py-20 overflow-hidden">
      ...
      >
        ...
        <div className="h-12 mb-8 flex items-center justify-center">
          <p className="text-xl md:text-2xl text-[#475569] font-mono">
            {displayText}
      ...
      >
        <motion.div
          ...
          className="w-6 h-10 rounded-full border-2 border-[#C6B4FF] flex items-start justify-center p-2"
        >
          <motion.div
            animate={{ y: [0, 12, 0] }}
            transition={{ duration: 2, repeat: Infinity }}
            className="w-1.5 h-1.5 bg-[#C6B4FF] rounded-full"
          />
        </motion.div>
      </motion.div>
    </section>
